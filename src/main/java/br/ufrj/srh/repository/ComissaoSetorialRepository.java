...
@Repository
public interface ComissaoSetorialRepository extends JpaRepository<ComissaoSetorial, Long> {
	 
//	private Session session;
// 
//	public void incluir(ComissaoSetorial comissaoSetorial) {
//		try {
//			session = HibernateUtil.getSessionFactory().openSession();
//			
//			session.beginTransaction();
//			session.save(comissaoSetorial);
...
//	}
// 
//	public void alterar(ComissaoSetorial comissaoSetorial) {
//		try {
//			session = HibernateUtil.getSessionFactory().openSession();
//			
//			session.beginTransaction();
//			session.merge(comissaoSetorial);
//			session.getTransaction().commit();
//		} catch (Exception e) {
//			session.getTransaction().rollback();
//			e.printStackTrace();
...
//	}
// 
//	public void excluir(ComissaoSetorial comissaoSetorial) {
//		try {
//			session = HibernateUtil.getSessionFactory().openSession();
//			
//			session.beginTransaction();
//			session.delete(comissaoSetorial);
//			session.getTransaction().commit();
//		} catch (Exception e) {
//			session.getTransaction().rollback();
//			e.printStackTrace();
...
//	}
	...
	public List<Servidor> listar_tp10_like(String sigepe); 
//	{
//		List<Servidor> lista = new ArrayList<Servidor>();
//		
//		try {
...
//			session.beginTransaction();
//			
//			String sql = "SELECT s.*,'0' as funcao FROM public.servidor as s WHERE sigepe LIKE '" + sigepe + "%' ORDER BY nome asc fetch first 6 rows only";
